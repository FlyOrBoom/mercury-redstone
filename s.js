...
//opa
  ...
  if(inOpa<1){
    document.getElementById('capsule0').style.opacity = Math.sqrt(inOpa);
    document.getElementById('booster0').style.opacity = Math.sqrt((inOpa));
    document.getElementById('capsule1').style.opacity = Math.sqrt(opa);
    document.getElementById('booster1').style.opacity = Math.sqrt(opa);
  }else{
    document.getElementById('capsule0').style.opacity = 1;
    document.getElementById('booster0').style.opacity = 1;
